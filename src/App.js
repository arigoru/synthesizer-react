...
var noteTypes = ["sine", "square", "sawtooth", "triangle"];
// coutrecy of @marcgg at https://gist.github.com/marcgg/94e97def0e8694f906443ed5262e9cbb
var noteValues = {
  C0: 16.35,
  "C#0": 17.32,
  Db0: 17.32,
...
class App extends Component {
  ...
  // and https://medium.com/swinginc/playing-with-midi-in-javascript-b6999f2913c3
  playNote = (note, duration, typeId) => {
    let o = context.createOscillator();
    let g = context.createGain();
    o.type = noteTypes[typeId];
  ...
  keyDownHandler = e => {
    switch (e.keyCode) {
      ...
      case 67:
        ...
        break;
      case 66:
        this.playNote("F3", 200, 3);
        break;
      case 86:
        this.playNote("F3", 200, 0);
        break;
      default:
        break;
    }
  ...
  componentDidMount() {
    ...
    this.appDiv.focus();
    this.setState(this.state); // force re-render for re-init
  }
  ...
  render() {
    return (
      ...
      >
        ...
        />
        <ControlPanel />
        <Piano playMidiHandler={this.playMidiNote} />
        <MIDISounds
